    ...
    <div class="flex-container">
        ...
        <nav class="breadcrumb has-arrow-separator" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="#" aria-current="page">Edit Global Project</a></li>
            </ul>
        </nav>
        ...
        <div class="card">
            <div class="card-content">
                ...
                {!! Form::model($globalProject, ['route' => ['global-project.update', $globalProject->id], 'method' => 'PATCH']) !!}

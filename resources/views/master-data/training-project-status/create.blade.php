    ...
    <div class="flex-container">
        ...
        <nav class="breadcrumb has-arrow-separator" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="#" aria-current="page">Add New Training Project Status</a></li>
            </ul>
        </nav>
        ...
        <div class="columns">
            <div class="column">
                ...
                <h1 class="title">
                    Add New Training Project Status
                </h1>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                {!! Form::open(['route' => 'training-project-status.store']) !!}
